...
$routes->get('/', 'Home::index');
$routes->get('/account', 'Pages::regis');
...
// $routes->get('/sampah/(:any)', 'Sampah::detail/$1');
...
$routes->delete('/akun/(:num)', 'User::delete/$1');
$routes->get('/akun/(:any)', 'User::detail/$1');


// $routes->get('/transaksi/(:any)', 'Transaksi::index/$1');
// $routes->get('/setor', 'Transaksi::setor');
